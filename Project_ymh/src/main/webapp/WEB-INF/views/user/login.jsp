...
<a class="navbar-brand js-scroll-trigger" href="${pagecontext.request.contextpath}/ymh" style="font-size:30px; width:50px;height:35px">Back</a>
...
<section class="stark-login">
  ...
  <form action="login" method="post">	
    ...
    <div style="display:inline-flex;">
      ...
      <input type="checkbox" name="idcheck"style="width:20px;"><h5>아이디저장</h5>
      </div>
        <input type="password" placeholder="Password" name="userPwd" style="margin-left:14px;" required >
          
        
       <div style="display:inline-flex;"> 
       <button type="submit" style="width:100px;height:50px;">로그인</button>&nbsp;&nbsp;&nbsp;   
       <a href="/ymh"><button type="button" style="width:50px;height:50px;">취소</button></a> 
       </div>
