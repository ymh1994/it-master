...
<section class="stark-login">
  ...
  <form action="signup" method="post">	
    ...
    <div style="display:inline-flex;padding-left:50px;">
      <input type="text" name="userId" placeholder="UserId" required >
      <button type="button"style="font-size:7px; width:50px;height:35px">중복확인</button>
      </div>
        <input type="password" placeholder="Password" name="userPwd" required>
          <input type="text" placeholder="userName" name="userName" required>
          
    <div style="display:inline-flex;"> 
       <button type="submit" style="width:100px;height:50px;">가입하기</button>&nbsp;&nbsp;&nbsp;   
